...
\begin{frame}{Fixing handling concurrent operations}
  \begin{figure}
    ...
    \includegraphics<3>[width=\columnwidth]{../2021-phd-day-figures/handling-concurrent-op-to-rename/3/figure.pdf}
    \includegraphics<4>[width=\columnwidth]{../2021-phd-day-figures/handling-concurrent-op-to-rename/4/figure.pdf}
    \includegraphics<5>[width=\columnwidth]{../2021-phd-day-figures/handling-concurrent-op-to-rename/5/figure.pdf}
    \caption{Handling properly concurrent update}
  \end{figure}
  \vspace{-3mm}
  \begin{itemize}
    \item<1-> Use \emph{epoch-based} system to track concurrent operations
    \item<4-> Use transform operations against \emph{rename} ones (\emph{OT})
  \end{itemize}
\end{frame}
